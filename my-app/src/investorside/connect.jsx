...
import profilepic from './naval_profile.jpeg'
import inboxpic1 from './savorysprout.png'
import inboxpic2 from './enlace.png'


const InvestorConnect = () => {
  const [searchTerm, setSearchTerm] = useState('');
  const [startups, setStartups] = useState([
    { id: 1, name: 'NourishNest', status: 'Approved', date: '15 Aug' },
    { id: 2, name: 'TechInnovate', status: 'Pending', date: '14 Aug' },
    { id: 3, name: 'QuantumLeap', status: null, date: null },
    { id: 4, name: 'CyberShield', status: null, date: null },
  ]);
  ...
  const [investments, setInvestments] = useState([
    {
      ...
      industry: 'Food industry · Kitchen · Restaurant',
      date: '19 Aug',
      logo: inboxpic1,
      status: 'pending',
    },
    {
      id: 2,
      name: 'Enlace textile LTD',
      description: 'Enlace textile LTD is a leading manufacturer of high-quality textiles and clothing.',
      industry: 'Textile industry · Clothing',
      date: '09 Aug',
      logo: inboxpic2,
      status: 'pending',
    },
              ...
              {investments.map((investment) => (
                <li key={investment.id} className="flex space-x-4 bg-white p-4 rounded">
                  ...
                  <div className="flex-grow">
                    ...
                    <p className="text-xs text-gray-500 mt-1">{investment.industry}</p>
