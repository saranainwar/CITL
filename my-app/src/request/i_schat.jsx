...
const StartupDashboard = () => {
  ...
  const formatDate = (dateValue, dateFormat) => {
    return Date.parse(dateValue) ? format(new Date(dateValue), dateFormat) : 'N/A';
  };
            ...
            >
              ...
              <div className="space-y-2 text-sm text-gray-600">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span>Founded: {formatDate(startup.companyFounded, 'MMM yyyy')}</span>
                </div>
                <div className="flex items-center gap-2">
              ...
              >
                ...
                >
                  ...
                  <span className="text-xs opacity-75 mt-1 block">
                    {formatDate(message.timestamp, 'MMM d, yyyy h:mm a')}
                  </span>
                </div>
              </div>
            ))}
