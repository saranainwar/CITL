...
//67263226ae4aa65ae28b8919
  ...
  useEffect(() => {
    ...
    return () => clearTimeout(interval); // Clear the timeout when the component unmounts or updates
  }, []);
  ...
  const filteredData = connectionRequests.filter(item =>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {filteredData.map(investor => (
            <div key={investor._id} className="bg-white rounded-lg shadow overflow-hidden">
              <div className="p-6">
                <h3 className="text-xl font-semibold mb-1">{investor.title}</h3>
